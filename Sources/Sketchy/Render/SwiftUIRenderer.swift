...
//  Native SwiftUI renderer for Sketchy drawings.
//
...
public struct SwiftUIRenderer {
    ...
    public func commands(for drawing: Drawing, options: Options, in size: CGSize) -> [RoughRenderCommand] {
        measurePerformance(RenderingSignpost.buildCommands, log: SketchyPerformanceLog.rendering, metadata: "shape=\(drawing.shape)") {
            ...
            if isSVGPath {
                svgTransform = measurePerformance(RenderingSignpost.svgTransform, log: SketchyPerformanceLog.rendering) {
