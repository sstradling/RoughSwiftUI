...
struct StrokeToFillConverter {
    ...
    static func convert(
        ...
        measurePerformance(PathOpsSignpost.strokeToFill, log: SketchyPerformanceLog.pathOps, metadata: "width=\(Int(baseWidth))") {
    ...
    static func convert(
        ...
        measurePerformance(PathOpsSignpost.strokeToFill, log: SketchyPerformanceLog.pathOps, metadata: "ops=\(operations.count)") {
