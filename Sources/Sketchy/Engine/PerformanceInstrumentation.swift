...
//  performance data from this package. Look for the "Sketchy" subsystem.
//
...
//  4. Filter by subsystem: "com.sketchy"
...
/// The unified signpost log for all Sketchy performance events.
///
/// Use this log with Instruments.app to profile rendering performance.
/// Filter by subsystem "com.sketchy" to see all events.
@usableFromInline
let sketchyPerformanceLog = OSLog(
    subsystem: "com.sketchy",
    category: .pointsOfInterest
)

/// Specialized logs for different subsystems.
/// These allow filtering by category in Instruments.
public enum SketchyPerformanceLog {
...
///
/// Set `SKETCHY_PERFORMANCE_INSTRUMENTATION` in your build settings
...
public func measurePerformance<T>(
    _ name: StaticString,
    log: OSLog = sketchyPerformanceLog,
    metadata: String? = nil,
...
public final class PerformanceStatistics: @unchecked Sendable {
    ...
    public func generateReport() -> String {
        ...
        var report = "=== Sketchy Performance Report ===\n\n"
